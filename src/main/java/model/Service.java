...
public class Service {
    ...
    private Double poolArea; // Dùng Double để cho phép null
    private Integer numberOfFloors; // Dùng Integer để cho phép null
    ...
    public Service(int serviceId, String serviceName, int serviceArea, double serviceCost, int serviceMaxPeople,
                   ...
                   Double poolArea, Integer numberOfFloors, String freeServiceIncluded) {
